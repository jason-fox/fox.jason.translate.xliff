...
[![Build Status](https://api.travis-ci.com/jason-fox/fox.jason.translate.xliff.svg?branch=master)](https://travis-ci.com/github/jason-fox/fox.jason.translate.xliff)
...
-   [Usage](#usage)
    ...
    -   [Populating Skeletons from the command line](#populating-skeletons-from-the-command-line)
